...
namespace finefin.Application.UseCases.Transaction.Create
{
    public class CreateTransaction : ICreateTransaction
    {
        ...
        public CreateTransaction(ITransactionRepository transactionRepository, IRecurrenceRepository recurrenceRepository, IWalletRepository walletRepository, ICreateTransactionValidation validator, IUnitOfWork unitOfWork, IMapper mapper)
        {
        ...
        public async Task Execute(string userId, CreateTransactionRequest request)
        {
