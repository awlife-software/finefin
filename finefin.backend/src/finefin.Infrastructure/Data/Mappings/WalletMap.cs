...
namespace finefin.Infrastructure.Data.Mappings
{
    public class WalletMap : IEntityTypeConfiguration<Wallet>
    {
        public void Configure(EntityTypeBuilder<Wallet> builder)
        {
            ...
            builder.Property(x => x.Type).HasColumnName("WLT_TYPE").HasConversion<string>().HasMaxLength(50);
            builder.Property(x => x.Name).HasColumnName("WLT_NAME").HasMaxLength(200);
            builder.Property(x => x.Color).HasColumnName("WLT_COLOR").HasConversion<string>().HasMaxLength(50);
